...
const SlatContent: React.FC<SlatContentProps> = ({
  items,
  onItemSelect,
  sidebarOpen,
  searchText,
              ...
              >
                ...
                <Grid container spacing={2} sx={{ mb: 3, flexWrap: "nowrap" }}>
                  ...
                  <Grid item xs={12} md={2.4}>
                    ...
                    <EllipsisText>Delivery Date: {item.itemData.dates.deliveryDate}</EllipsisText>
                    <EllipsisText>Total Costs: {item.itemData.dates.totalCosts}</EllipsisText>
                  </Grid>

                  {/* Column 4 */}
                  <Grid item xs={12} md={2.4}>
                    <EllipsisText>Sales Total: {item.itemData.amounts.salesTotal}</EllipsisText>
                    <EllipsisText>Subtotal: {item.itemData.amounts.subtotal}</EllipsisText>
                    <EllipsisText>Sales Total 2: {item.itemData.amounts.salesTotal2}</EllipsisText>
                    <EllipsisText>
                  ...
                  <Grid item xs={12} md={2.4}>
                    ...
                    <EllipsisText>Hrs Profit: {item.itemData.percentages.hrsProfit}</EllipsisText>
                    <EllipsisText>Hrs %: {item.itemData.percentages.hrsPercent}</EllipsisText>
                    <EllipsisText>Hrs Left: {item.itemData.percentages.hrsLeft}</EllipsisText>
                  </Grid>
                </Grid>
              </Box>
